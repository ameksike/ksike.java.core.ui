 ...
 * @made 22/04/2019
 */
public class KsButton extends JButton implements MouseListener {
    ...
    public KsButton(String value, String type) {
        super();
        this.initProperties();
        this.initLayout();
    ...
    public KsButton(String value, String type, KsMouseListener handler) {
        super();
        this.initProperties();
        this.initLayout();
        this.initCmp(value, type);
    ...
    private void update() {
        ...
        this.setPreferredSize(new Dimension(width, (int) this.getSize().getHeight()));
        this.repaint();
        this.revalidate();
    }
    ...
    private void initIcon() {
        try {
            ...
            Logger.getLogger(KsButton.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
